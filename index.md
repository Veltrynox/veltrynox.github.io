...
<section class="hero">
  ...
  <div class="hero-links">
    ...
    <a href="assets/Ivan_Larinin_Resume.pdf" download="Ivan_Larinin_Resume.pdf" class="btn btn-secondary">📄 Download Resume (PDF)</a>
  </div>
</section>
...
<section id="contact" class="contact-section">
  <div class="contact-card">
    ...
    <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
      <a href="https://github.com/Veltrynox" target="_blank" rel="noopener" class="btn btn-primary">📂 GitHub Profile</a>
      <a href="https://www.artstation.com/ivanlarinin" target="_blank" rel="noopener" class="btn btn-secondary">🎨 ArtStation</a>
      <a href="mailto:ilarin75@gmail.com" class="btn btn-secondary">✉️ Email Me</a>
      <a href="assets/Ivan_Larinin_Resume.pdf" download="Ivan_Larinin_Resume.pdf" class="btn btn-secondary">📄 Resume (PDF)</a>
    </div>
  </div>
</section>
